...
var wallet=hdWallet;
console.log(`Masterkey: ${'0x'+wallet.privateKey.toString('hex')}`);

wallet = wallet.deriveChild(0x80000000+44);
console.log(`Derive 44': ${'0x'+wallet.privateKey.toString('hex')}`);

wallet = wallet.deriveChild(0x80000000+60);
console.log(`Derive 60': ${'0x'+wallet.privateKey.toString('hex')}`);

wallet = wallet.deriveChild(0x80000000+0);
console.log(`Derive  0': ${'0x'+wallet.privateKey.toString('hex')}`);
...
console.log(`Corresponding account: ${account.address}`);
